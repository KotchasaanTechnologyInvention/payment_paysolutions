# PaySolutions Payment Provider for Odoo 17.0
...
- **Odoo Version**: 17.0 (for other versions, see branches: [17.0](../../tree/17.0), [18.0](../../tree/18.0))
...
1. Visit the [PaySolutions module page](https://apps.odoo.com/apps/modules/17.0/payment_paysolutions/) on Odoo App Store
...
unzip payment_paysolutions-17.X.X.X.X.zip
```
...
- Odoo version (e.g., 17.X.X.X)
- Module version (e.g., 17.X.X.X)
...
### Version 17.0.2.0.0 (March 19, 2026)
...
### Version 17.0.1.0.0 (February 2, 2026)
