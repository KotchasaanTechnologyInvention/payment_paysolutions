# PaySolutions Payment Provider for Odoo 18.0
...
- **Odoo Version**: 18.0 (for other versions, see branches: [17.0](../../tree/17.0), [19.0](../../tree/19.0))
...
1. Visit the [PaySolutions module page](https://apps.odoo.com/apps/modules/18.0/payment_paysolutions/) on Odoo App Store
